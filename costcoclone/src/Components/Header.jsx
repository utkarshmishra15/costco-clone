  ...
  return (
    <Box>
      <Text
        ...
        bg={
          "linear-gradient(90deg, rgba(66,234,247,1) 0%,  rgba(66,234,247,1) 100%)"
        }
        p={0.5}
      >
        Spend $100 or more only on sameday.costco.com and receive instant* $30 OFF. Use this one-time use code at checkout: SDHOLIDAY2024
      </Text>
      <Flex
        gap={8}
